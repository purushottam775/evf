        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-2xl font-bold">EV Charge</span>
            </div>
            <p className="text-gray-400 mb-4">
              Your trusted partner for electric vehicle charging solutions. 
              Find, book, and charge at thousands of stations nationwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/login" className="text-gray-400 hover:text-green-500 transition">
                  Login
                </Link>
              </li>
              <li>
